(function () {
	...
	try{if(typeof document != 'undefined'){var elementStyle = document.createElement('style');elementStyle.appendChild(document.createTextNode("*,::before,::after{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgb(0 0 0 / 0);--un-ring-shadow:0 0 rgb(0 0 0 / 0);--un-shadow-inset: ;--un-shadow:0 0 rgb(0 0 0 / 0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgb(147 197 253 / 0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}::backdrop{--un-rotate:0;--un-rotate-x:0;--un-rotate-y:0;--un-rotate-z:0;--un-scale-x:1;--un-scale-y:1;--un-scale-z:1;--un-skew-x:0;--un-skew-y:0;--un-translate-x:0;--un-translate-y:0;--un-translate-z:0;--un-pan-x: ;--un-pan-y: ;--un-pinch-zoom: ;--un-scroll-snap-strictness:proximity;--un-ordinal: ;--un-slashed-zero: ;--un-numeric-figure: ;--un-numeric-spacing: ;--un-numeric-fraction: ;--un-border-spacing-x:0;--un-border-spacing-y:0;--un-ring-offset-shadow:0 0 rgb(0 0 0 / 0);--un-ring-shadow:0 0 rgb(0 0 0 / 0);--un-shadow-inset: ;--un-shadow:0 0 rgb(0 0 0 / 0);--un-ring-inset: ;--un-ring-offset-width:0px;--un-ring-offset-color:#fff;--un-ring-width:0px;--un-ring-color:rgb(147 197 253 / 0.5);--un-blur: ;--un-brightness: ;--un-contrast: ;--un-drop-shadow: ;--un-grayscale: ;--un-hue-rotate: ;--un-invert: ;--un-saturate: ;--un-sepia: ;--un-backdrop-blur: ;--un-backdrop-brightness: ;--un-backdrop-contrast: ;--un-backdrop-grayscale: ;--un-backdrop-hue-rotate: ;--un-backdrop-invert: ;--un-backdrop-opacity: ;--un-backdrop-saturate: ;--un-backdrop-sepia: ;}.\\!container{width:100% !important;}.container{width:100%;}@media (min-width: var(--breakpoints-sm)){.\\!container{max-width:var(--breakpoints-sm) !important;}.container{max-width:var(--breakpoints-sm);}}@media (min-width: var(--breakpoints-md)){.\\!container{max-width:var(--breakpoints-md) !important;}.container{max-width:var(--breakpoints-md);}}@media (min-width: var(--breakpoints-ld)){.\\!container{max-width:var(--breakpoints-ld) !important;}.container{max-width:var(--breakpoints-ld);}}@media (min-width: var(--breakpoints-xl)){.\\!container{max-width:var(--breakpoints-xl) !important;}.container{max-width:var(--breakpoints-xl);}}.visible{visibility:visible;}.absolute{position:absolute;}.relative{position:relative;}.inset-0{inset:0;}.mt-4{margin-top:1rem;}.mt-8{margin-top:2rem;}.hidden{display:none;}.flex{display:flex;}.flex-grow-1{flex-grow:1;}.flex-col{flex-direction:column;}.resize{resize:both;}.items-center{align-items:center;}.justify-end{justify-content:flex-end;}.justify-center{justify-content:center;}.b{border-width:1px;}.border-2{border-width:2px;}.border-5{border-width:5px;}.border-information-500{border-color:var(--information-500);}.rounded-md{border-radius:0.375rem;}.rounded-xl{border-radius:0.75rem;}.bg-information-100{background-color:var(--information-100) /* var(--information-100) */;}.bg-information-500{background-color:var(--information-500) /* var(--information-500) */;}.p-2{padding:0.5rem;}.px,.px-4{padding-left:1rem;padding-right:1rem;}.px-2{padding-left:0.5rem;padding-right:0.5rem;}.py-2{padding-top:0.5rem;padding-bottom:0.5rem;}.text-3xl{font-size:1.875rem;line-height:2.25rem;}.text-8xl{font-size:6rem;line-height:1;}.text-xl{font-size:1.25rem;line-height:1.75rem;}.text-base-white{color:var(--base-white) /* var(--base-white) */;}.text-information-500{color:var(--information-500) /* var(--information-500) */;}.text-information-700{color:var(--information-700) /* var(--information-700) */;}.font-bold{font-weight:700;}.blur{--un-blur:blur(8px);filter:var(--un-blur) var(--un-brightness) var(--un-contrast) var(--un-drop-shadow) var(--un-grayscale) var(--un-hue-rotate) var(--un-invert) var(--un-saturate) var(--un-sepia);}body {\n  min-height: 100vh;\n  display: flex;\n  flex-direction: column;\n}\n\n#standalone-app-react {\n  display: flex;\n  flex-direction: column;\n  flex-grow: 1;\n}"));document.head.appendChild(elementStyle);}}catch(e){console.error('vite-plugin-css-injected-by-js', e);}

})();
import { r as requireReact, a as requireReactDom, j as jsxRuntimeExports, c as clientExports } from './style-BQO932oL.js';
...
const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "/app-react/v1.0.0/"+dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-information-100 text-base-white rounded-md border-5 border-information-500 flex-grow-1 p-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-information-500 text-base-white px-2 rounded-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "App-react" }),
...
const routesConfig = [
  {
    path: '/app-react',
    lazy: () => __vitePreload(() => import('./Home-CqbdnNiy.js'),true              ?[]:void 0),
    meta: {
      title: 'Home',
      icon: '',
      showInSidebar: true,
  ...
  },
  {
    ...
    lazy: () => __vitePreload(() => import('./Page1-vnVqoKz_.js'),true              ?[]:void 0),
    meta: {
      title: 'Page 1',
      icon: '',
      showInSidebar: true,
  ...
  },
  {
    ...
    lazy: () => __vitePreload(() => import('./Page2-CYsx89Yi.js'),true              ?[]:void 0),
    meta: {
      title: 'Page 2',
      icon: '',
      showInSidebar: true,
  ...
  },
  {
    ...
    lazy: () => __vitePreload(() => import('./Page3-CPXGiDux.js'),true              ?[]:void 0),
    meta: {
      title: 'Page 3',
      icon: '',
      showInSidebar: true,
...
let router = null;
let root = null;
const getRoutes = () => routesConfig.map(({ lazy, ...rest }) => rest);
const mount = async ({
  domElement,
  initialPath,
  onNavigate,
  ...
  const entryRoute = {
    ...
    hydrateFallbackElement: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {}),
    children: routesConfig
  };
  router = isStandalone ? createBrowserRouter([entryRoute]) : createMemoryRouter([entryRoute], { initialEntries: [initialPath || "/"] });
  ...
  root = clientExports.createRoot(domElement);
  root.render(
...
export { Link as L, bootstrap, getRoutes, mount, unmount };
