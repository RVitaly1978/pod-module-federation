...
const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "/app-react/v2.0.0/"+dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative bg-information-300 text-base-white rounded-md border-5 border-information-500 flex-grow-1 p-2", children: [
...
const routesConfig = [
  {
    path: '/app-react',
    lazy: () => __vitePreload(() => import('./Home-CcGpZl5q.js'),true              ?[]:void 0),
    meta: {
      title: 'Home',
      icon: '',
      showInSidebar: true,
