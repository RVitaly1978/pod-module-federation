...
function _sfc_render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [...(_cache[0] || (_cache[0] = [
    _createElementVNode("h1", { className: "text-3xl text-error-700" }, "Vue 3", -1),
    _createElementVNode("h2", { className: "text-8xl mt-4 text-error-500 font-bold" }, "Page 2", -1)
  ]))]))
}
const Page2 = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);
