...
const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "/app-vue3/v2.0.0/"+dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
...
const _hoisted_1 = { class: "relative bg-error-300 text-base-white rounded-md border-5 border-error-500 flex-grow-1 p-2" };
...
const routesConfig = [
  {
    path: '/app-vue3',
    component: () => __vitePreload(() => import('./Home-ZhPfO20m.js'),true              ?[]:void 0),
    meta: {
      title: 'Home',
      icon: '',
      showInSidebar: true,
