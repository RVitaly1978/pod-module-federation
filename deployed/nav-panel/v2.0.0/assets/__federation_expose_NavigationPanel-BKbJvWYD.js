...
const _hoisted_1 = { class: "w-full bg-warning-300 rounded-md border-5 border-warning-500 px-4 py-2 flex items-center justify-between" };
...
const NavigationPanel = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-15339db3"]]);
